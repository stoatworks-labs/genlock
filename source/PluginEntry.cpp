/**
    ...
    the `CFFGLPluginInfo` that Genlock.cpp registers at static-initialisation
    ...
    binary: which build it is.
        ...
        strings Genlock.bundle/Contents/MacOS/Genlock | grep genlock
*/

extern "C" const char* GenlockBuildStamp()
{
	return "genlock " GENLOCK_VERSION " built " __DATE__ " " __TIME__;
}
